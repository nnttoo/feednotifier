...
export default class SettingPage extends MyComponent{
    constructor(props){ 
        ...
        this.showInputMenu = window.showInputMenu;
        if(typeof this.showInputMenu == "undefined"){
            this.showInputMenu = null
        }
    } 
            ...
            <div id="spage" >
                ...
                <div className="bottomel tbframe"> 
                    ...
                    <div className="tc tcnwrap tcvm iptparent">
                        <input onContextMenu={this.showInputMenu} type="text" className="form-control addinput"/>
                    </div>                   
